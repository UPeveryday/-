...
{
    public class Xmlconfig : Screen, IXmlconfig
    {
        ...
        public void UpdataAllAddNodeConfigXml(string ConnenctionString, string strKey)
        {
        ...
        /// <returns></returns>
        public string GetAddNodeValue(string key)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public XmlConfigAdd GetAllXmlItem()
        {
